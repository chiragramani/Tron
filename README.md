...
3. Peter Reinhardt has authored an amazing [article](https://segment.com/blog/mobile-app-size-effect-on-downloads/) that talks about the "Effect of Mobile App Size on Downloads". Please refer to the article for more details about impact on installation rate etc. 
